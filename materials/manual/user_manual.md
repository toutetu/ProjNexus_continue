...
> 最終更新日：2026-05-12 ／ 対象：Phase 5 提出前（`main` 相当の現行 UI）
...
### 4.6 タスク一覧で開発進捗を俯瞰する（カンバン・メンバー別）
